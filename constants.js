...
// Aggregated actions
var MOVING_RIGHT = ['WALK_RIGHT', 'RUN_RIGHT'];
var MOVING_LEFT = ['WALK_LEFT', 'RUN_LEFT'];
var FACING_RIGHT = ['WALK_RIGHT', 'RUN_RIGHT', 'ATTACK_RIGHT', 'STOP_RIGHT', 'JUMP_RIGHT'];
var FACING_LEFT = ['WALK_LEFT', 'RUN_LEFT', 'ATTACK_LEFT', 'STOP_LEFT', 'JUMP_LEFT'];
